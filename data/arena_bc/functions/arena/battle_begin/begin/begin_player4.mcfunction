effect give @a resistance infinite 0 true
...
schedule function arena_bc:arena/battle_begin/begin/2 2s append
schedule function arena_bc:arena/battle_begin/begin/1 4s append
schedule function arena_bc:arena/battle_begin/begin/start 6s append
