...
execute positioned ~ ~-1 ~ if entity @a[team=!red,distance=..1.5] run function arena_bc:more_skills/abe_kiri/playera/ray/ray_true
execute positioned ~ ~-1.5 ~ if entity @a[team=!red,distance=..1.5] run function arena_bc:more_skills/abe_kiri/playera/ray/ray_false
tp @s ^ ^ ^0.25