scoreboard players remove #playerb_zi_times rays 1
#对准十字准心
...
execute positioned ~ ~-1 ~ if entity @a[team=!blue,distance=..1.5] run function arena_bc:more_skills/abe_kiri/playerb/ray/ray_true
execute positioned ~ ~-1.5 ~ if entity @a[team=!blue,distance=..1.5] run function arena_bc:more_skills/abe_kiri/playerb/ray/ray_false
tp @s ^ ^ ^0.25