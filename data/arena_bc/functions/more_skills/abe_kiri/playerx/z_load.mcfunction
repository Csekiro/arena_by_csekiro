...
give @s warped_fungus_on_a_stick{charge_rifle:1b,CustomModelData:67,display:{Lore:['{"color":"aqua","text":"消耗能量子弹","italic":false}'],Name:'{"color":"gold","text":"CHARGE_RIFLE","italic":true}'}}
give @s nether_star{display:{Name:'{"color":"yellow","text":"能量子弹","italic":true}'}} 2
function arena_bc:more_skills/abe_kiri/playerx/perform_t