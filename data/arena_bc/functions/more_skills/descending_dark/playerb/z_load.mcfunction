...
scoreboard players reset #playerb max_pos
scoreboard players reset #playerb min_pos
...
function arena_bc:more_skills/descending_dark/playerb/perform_t
function arena_bc:more_skills/descending_dark/playerb/onground_t