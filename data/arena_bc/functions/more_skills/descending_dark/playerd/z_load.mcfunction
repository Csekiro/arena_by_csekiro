...
scoreboard players reset #playerd max_pos
scoreboard players reset #playerd min_pos
...
function arena_bc:more_skills/descending_dark/playerd/perform_t
function arena_bc:more_skills/descending_dark/playerd/onground_t