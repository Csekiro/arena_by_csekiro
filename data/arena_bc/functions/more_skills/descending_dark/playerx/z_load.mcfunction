...
scoreboard players reset #playerx max_pos
scoreboard players reset #playerx min_pos
...
function arena_bc:more_skills/descending_dark/playerx/perform_t
function arena_bc:more_skills/descending_dark/playerx/onground_t