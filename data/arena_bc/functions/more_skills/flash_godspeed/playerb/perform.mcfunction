...
schedule function arena_bc:more_skills/flash_godspeed/playerb/perform1 16t replace
schedule function arena_bc:more_skills/flash_godspeed/playerb/perform2 26t replace
