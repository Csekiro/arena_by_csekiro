...
schedule function arena_bc:more_skills/flash_godspeed/playerc/perform1 16t replace
schedule function arena_bc:more_skills/flash_godspeed/playerc/perform2 26t replace
