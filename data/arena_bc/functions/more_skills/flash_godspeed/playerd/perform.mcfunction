...
schedule function arena_bc:more_skills/flash_godspeed/playerd/perform1 16t replace
schedule function arena_bc:more_skills/flash_godspeed/playerd/perform2 26t replace
