...
schedule function arena_bc:more_skills/flash_godspeed/playerx/perform1 16t replace
schedule function arena_bc:more_skills/flash_godspeed/playerx/perform2 26t replace
