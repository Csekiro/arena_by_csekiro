tag @e[sort=nearest,type=!player,tag=!my_arrow_playera,tag=!not_my_arrow_playera,limit=1] add uuid_detect_playera
...
execute as @e[tag=uuid_detect_playera] at @s if score #playera uuid_detect matches 4 run function arena_bc:netherite_axe/infinity/playera/owner_detect/my_arrow
execute as @e[tag=uuid_detect_playera] at @s unless score #playera uuid_detect matches 4 run function arena_bc:netherite_axe/infinity/playera/owner_detect/not_my_arrow