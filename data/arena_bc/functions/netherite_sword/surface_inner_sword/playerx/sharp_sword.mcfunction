...
give @s minecraft:netherite_sword{sharp_sword:1b,Unbreakable:1b,display:{Name:'{"text":"業火餘燼之刃[sharp]"}'},Enchantments:[{id:"minecraft:sharpness",lvl:5},{id:"minecraft:sweeping",lvl:10}]}
