...
scoreboard players reset #uuid0_playera2 player_uuid
...
execute store result score #uuid0_playera2 player_uuid run data get entity @a[tag=!playera,team=red,limit=1] UUID[0]
