function arena_bc:royal_guard/playerc/defence_art/z_load
function arena_bc:royal_guard/playerc/infinity/owner_detect/z_load
function arena_bc:royal_guard/playerc/perform_t
