function arena_bc:royal_guard/playerd/defence_art/z_load
function arena_bc:royal_guard/playerd/infinity/owner_detect/z_load
function arena_bc:royal_guard/playerd/perform_t
