#循环，ghast触发，执行者为playera,条件：手持fake ghast
...
tag @e[tag=ghast_playera,limit=1] add ghast_defence_playera
tp @e[tag=ghast_playera,limit=1] @s
scoreboard players remove @a[tag=playera,limit=1] summoner_energy_playera 5