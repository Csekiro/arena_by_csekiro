...
scoreboard players set #sound_playerb sound_summoner 10
...
execute as @e[tag=midnight,limit=1] at @s run summon phantom ~ ~3 ~ {Size:2,Team:"blue",Glowing:1b,Tags:["s_playerb"],Fire:-10000}
...
difficulty hard
bossbar set minecraft:summoner_energy_playerb color red
