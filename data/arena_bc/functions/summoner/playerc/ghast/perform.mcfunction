#循环，ghast触发，执行者为playerc,条件：手持fake ghast
...
tag @e[tag=ghast_playerc,limit=1] add ghast_defence_playerc
tp @e[tag=ghast_playerc,limit=1] @s
scoreboard players remove @a[tag=playerc,limit=1] summoner_energy_playerc 5