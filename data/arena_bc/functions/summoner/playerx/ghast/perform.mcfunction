#循环，ghast触发，执行者为playerx,条件：手持fake ghast
...
tag @e[tag=ghast_playerx,limit=1] add ghast_defence_playerx
tp @e[tag=ghast_playerx,limit=1] @s
scoreboard players remove @a[tag=playerx,limit=1] summoner_energy_playerx 5