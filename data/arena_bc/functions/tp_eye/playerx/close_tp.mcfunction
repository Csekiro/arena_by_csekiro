...
execute unless predicate arena_bc:mainhand/pumpkin_pie run scoreboard players remove #playerx tp_eye 105
...
execute unless predicate arena_bc:mainhand/pumpkin_pie unless entity @s[x_rotation=-90..-84] run tp @s ^ ^ ^3
execute unless predicate arena_bc:mainhand/pumpkin_pie if entity @s[x_rotation=-90..-84] run tp @s ~ ~3 ~
