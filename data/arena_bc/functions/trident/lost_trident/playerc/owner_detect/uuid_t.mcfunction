...
execute as @e[tag=uuid_detect_playerc] at @s if score #playerc uuid_detect matches 4 run function arena_bc:trident/lost_trident/playerc/owner_detect/my_trident
execute as @e[tag=uuid_detect_playerc] at @s unless score #playerc uuid_detect matches 4 run function arena_bc:trident/lost_trident/playerc/owner_detect/not_my_trident