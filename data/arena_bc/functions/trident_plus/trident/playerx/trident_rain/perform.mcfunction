...
execute if score #playerx tr_times matches 35 as @e[tag=trident_rain_playerx] at @s run summon lightning_bolt ^ ^-7 ^
execute if score #playerx tr_times matches 0 run kill @e[tag=trident_rain_playerx]
execute unless score #playerx tr_times matches 0 run schedule function arena_bc:trident_plus/trident/playerx/trident_rain/perform_trigger 1t append