scoreboard players remove playera_beng_times rays 1
...
execute positioned ~ ~-1 ~ if entity @a[tag=!playera,distance=..0.5] run function fps:charge_rifle/playera/beng/ray_true
execute positioned ~ ~-1.5 ~ if entity @a[tag=!playera,distance=..0.5] run function fps:charge_rifle/playera/beng/ray_true
tp @s ^ ^ ^0.5
