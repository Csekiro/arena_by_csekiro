...
execute positioned ~ ~-1 ~ if entity @a[tag=!playerx,distance=..0.5] run function fps:charge_rifle/playerx/zi/ray_true
execute positioned ~ ~-1.5 ~ if entity @a[tag=!playerx,distance=..0.5] run function fps:charge_rifle/playerx/zi/ray_true
tp @s ^ ^ ^0.25
