...
execute as @e[tag=line,limit=1] at @s run function particles:line_lava/line_perform
execute if score #line_times line matches 0 run function particles:line_lava/line_finish
execute unless score #line_times line matches 0 run function particles:line_lava/line_performt
